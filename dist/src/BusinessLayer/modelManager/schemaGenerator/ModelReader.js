...
export class ModelReader {
    ...
    */
     ...
     * @param {string} fieldName - The name of the field.
     */
    static addFieldToType(fieldTypes, type, fieldName) {
        if (!fieldTypes[type]) {
            fieldTypes[type] = [];
        }
     ...
     * @param {string} fieldName - The name of the field.
     */
    static processFieldAttributes(Field, attributes, fieldName) {
     ...
     * @param {string} fieldName - The name of the field.
     */
    static addFieldToAttribute(attributes, FieldProperty, fieldName) {
