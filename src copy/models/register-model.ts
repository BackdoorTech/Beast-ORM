...
export class registerLocalStorage {
  static async register(entries: register) {
    ...
    for (const modelClassRepresentations of entries.models) {
      ...
      this.edit(ModelName, databaseSchema, modelClassRepresentations, entries)
      ModelEditor.setTableSchemaLocalStorage(modelClassRepresentations as typeof LocalStorage, databaseSchema.stores[index])
    ...
    for (const modelClassRepresentations of entries.models) {
      ModelEditor.getDBSchemaLocalStorage(modelClassRepresentations as typeof LocalStorage, databaseSchema)
    }
...
export class ModelEditor {
  ...
  static setTableSchemaLocalStorage(ModelToEdit: typeof LocalStorage, TableSchema: TableSchema) {
